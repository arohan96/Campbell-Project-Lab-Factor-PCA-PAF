classdef RDfactorRotation
    ...
    methods
        ...
        function [normalizedLoadings] = kaiserNormalization(obj, eigenValues)
            ...
            for i = 1:k
                obj.factorLoadings(:, i) = obj.factorLoadings(:, i) / sqrt(eigenValues(i));
            end
        ...
        function [rotatedLoadings] = varimaxRotation(obj, builtInNormalizeLoadings)
            % varimax: (gamma = 1)
            ...
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'varimax', 'Normalize', builtInNormalizeLoadings); % Normalize (default = on)
        end

        function [rotatedLoadings] = parsimaxRotation(obj, builtInNormalizeLoadings)
            ...
            maxit = 1000;
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'parsimax', 'Maxit', maxit, 'Normalize', builtInNormalizeLoadings);
        end

        function [rotatedLoadings] = quartimaxRotation(obj, builtInNormalizeLoadings)
            % quartimax: (gamma = 0)
            ...
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'quartimax', 'Normalize', builtInNormalizeLoadings);
        end

        function [rotatedLoadings] = promaxRotation(obj, builtInNormalizeLoadings)
            % promax:(gamma > 1)
            ...
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'promax', 'Normalize', builtInNormalizeLoadings);
        end

        function [rotatedLoadings] = orthomaxRotation(obj, builtInNormalizeLoadings, orthoGamma)
            % orthomax: (0 < gamma < 1)
            ...
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'orthomax', 'Normalize', builtInNormalizeLoadings, 'Coeff', orthoGamma);
        end

        function [rotatedLoadings] = equamaxRotation(obj, builtInNormalizeLoadings)
            ...
            rotatedLoadings = rotatefactors(obj.factorLoadings, 'Method', 'equamax', 'Maxit', maxit, 'Normalize', builtInNormalizeLoadings);
        end
