classdef factorRotation
    ...
    methods
        ...
        function [rotatedLoadings] = parsimaxRotation(obj, builtInNormalizeLoadings)
            ...
            maxit = 1000;
            rotatedLoadings = rotatefactors(obj, 'Method', 'parsimax', 'Maxit', maxit, 'Normalize', builtInNormalizeLoadings);
        end
        ...
        function [rotatedLoadings] = quartimaxRotation(obj, builtInNormalizeLoadings)
            ...
            rotatedLoadings = rotatefactors(obj, 'Method', 'quartimax', 'Normalize', builtInNormalizeLoadings);
        end
        ...
        function [rotatedLoadings] = promaxRotation(obj, builtInNormalizeLoadings)
            ...
            rotatedLoadings = rotatefactors(obj, 'Method', 'promax', 'Normalize', builtInNormalizeLoadings);
        end
        ...
        function [rotatedLoadings] = orthomaxRotation(obj, builtInNormalizeLoadings, orthoGamma)
            ...
            rotatedLoadings = rotatefactors(obj, 'Method', 'orthomax', 'Normalize', builtInNormalizeLoadings, 'Coeff', orthoGamma);
        end
        ...
        function [rotatedLoadings] = equamaxRotation(obj, builtInNormalizeLoadings)
            ...
            rotatedLoadings = rotatefactors(obj, 'Method', 'equamax', 'Maxit', maxit, 'Normalize', builtInNormalizeLoadings);
        end
